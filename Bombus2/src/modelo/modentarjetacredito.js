module.exports = {
    ...
    update: function(conection,datos,id_usuario,cb) {
        conection.query(`UPDATE tarjetacredito SET tarjetacredito = '${datos.numero_tarjeta}', fecha_caducidad = '${datos.fechacaducidad}', csv = '${datos.csv}', id_usuario = '${datos.id_usuario}', WHERE id_usuario = '${id_usuario}'`,cb);
    },
